  ...
  return (
    <>
      <div>
              ...
              selectedItem && (
                <div className='flex flex-col gap-4'>
                  ...
                  <div className='flex gap-2 mt-2'>
                    <Button text={'Cerrar'} className={'none'} func={() => setIsActiveModal(false)} />
                    <Button text={'Cancelar Reserva'} className={'danger'} func={handleCancelReserva} disabled={saving || ['completada','cancelada'].includes((selectedItem?.estado || '').toLowerCase())} />
        ...
        {message && <div className='fixed bottom-4 right-4 bg-dark/80 text-white px-3 py-2 rounded'>{message}</div>}
      </div>
    </>
  );
}
