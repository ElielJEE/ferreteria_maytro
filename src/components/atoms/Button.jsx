...
export default function Button({ func, text, type, className, icon }) {
	const ColorVariants = {
		...
		transparent: 'bg-transparent hover:bg-primary text-dark hover:text-light border border-dark/20'
	}
