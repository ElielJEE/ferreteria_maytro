			...
			</div>
			{
				isActiveModal && (
					<ModalContainer
						...
						modalTitle={mode === 'edit' ? 'Editar Cliente' : `¿Estas seguro que deseas eliminar a ${cliente.nombre} de la lista de clientes?`}
						modalDescription={mode === 'edit' ? 'Edita la informacion del cliente' : 'Esta accion no se puede deshacer.'}
