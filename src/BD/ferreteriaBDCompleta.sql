...
CREATE TABLE IF NOT EXISTS MOVIMIENTOS_INVENTARIO (
  ...
  usuario_id INT NULL,
  tipo_movimiento ENUM('entrada','salida','ajuste','transferencia','ajuste_danado','reservado') NOT NULL,
  cantidad INT NOT NULL,
  motivo VARCHAR(255),
  ...
  CONSTRAINT fk_mov_prod FOREIGN KEY (producto_id) REFERENCES PRODUCTOS(ID_PRODUCT) ON DELETE SET NULL ON UPDATE CASCADE,
...
ALTER TABLE PRODUCTOS ADD COLUMN IF NOT EXISTS ID_SUCURSAL VARCHAR(10);
ALTER TABLE PRODUCTOS ADD INDEX IF NOT EXISTS idx_productos_idsucursal (ID_SUCURSAL);
ALTER TABLE PRODUCTOS
  ADD CONSTRAINT IF NOT EXISTS fk_productos_sucursal
    FOREIGN KEY (ID_SUCURSAL) REFERENCES SUCURSAL(ID_SUCURSAL)
    ON DELETE SET NULL ON UPDATE CASCADE;
