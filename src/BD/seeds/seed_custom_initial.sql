...
-- NOTE: ID_SUCURSAL removed from PRODUCTOS; per-sucursal stock lives in STOCK_SUCURSAL
INSERT INTO PRODUCTOS (ID_PRODUCT, CODIGO_PRODUCTO, PRODUCT_NAME, CANTIDAD, ID_SUBCATEGORIAS)
VALUES
  (1, 'HER001', 'Martillo 16oz', 50, 'SC1'),
  (2, 'HER002', 'Taladro Eléctrico 12V', 20, 'SC2'),
  (3, 'FER001', 'Juego de Tornillos 100u', 200, 'SC3')
ON DUPLICATE KEY UPDATE CODIGO_PRODUCTO = VALUES(CODIGO_PRODUCTO), PRODUCT_NAME = VALUES(PRODUCT_NAME), CANTIDAD = VALUES(CANTIDAD), ID_SUBCATEGORIAS = VALUES(ID_SUBCATEGORIAS);
